...
-- Volcando datos para la tabla skimia_instarespuesta.companies: ~1 rows (aproximadamente)
...
-- Volcando datos para la tabla skimia_instarespuesta.countries: ~218 rows (aproximadamente)
...
-- Volcando datos para la tabla skimia_instarespuesta.expert_ratings: ~1 rows (aproximadamente)
...
CREATE TABLE IF NOT EXISTS `members` (
  ...
  `time_query` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `email_UNIQUE` (`email`),
...
-- Volcando datos para la tabla skimia_instarespuesta.members: ~1 rows (aproximadamente)
/*!40000 ALTER TABLE `members` DISABLE KEYS */;
INSERT INTO `members` (`id`, `names`, `lastnames`, `email`, `password`, `headline`, `image`, `bio`, `facebookid`, `twitterid`, `linkedinid`, `countvotes`, `sumvotes`, `expert`, `administrator_id`, `registerdate`, `lastdate`, `expertdate`, `mobilephone`, `homephone`, `officephone`, `dni`, `commercialdni`, `company_id`, `title_id`, `termsandconditions`, `datetermsandconditions`, `category_id`, `city_id`, `verificationstatus`, `expertstatus`, `expertrating_id`, `expertrate`, `public`, `gain`, `charge`, `query`, `time_query`) VALUES
	(18, 'Wilmer', 'Alzate', 'wilmeralzateroman@gmail.com', 'c256ea1166942630c5eca51659f3344abce03580', '', 'Koala.jpg', NULL, NULL, NULL, NULL, 0, 0, 0, NULL, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL);
...
-- Volcando datos para la tabla skimia_instarespuesta.members_languages: 0 rows
...
-- Volcando datos para la tabla skimia_instarespuesta.members_skills: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla skimia_instarespuesta.skills: ~5 rows (aproximadamente)
...
-- Volcando datos para la tabla skimia_instarespuesta.titles: ~2 rows (aproximadamente)
