...
$template = array(
    ...
    'version'       => '1.0',
    'author'        => 'personal',
    'title'         => '.: InstaRespuesta | App:.',
    'description'   => 'Módulo de Front-End.',
...
$primary_nav = array(
    ...
    array(
        'name'  => 'User Interface',
        'icon'  => 'glyphicon-vector_path_circle',
        'sub'   => array(
            array(
                'name'  => 'Blocks',
        ...
        'sub'   => array(
            ...
            array(
                ...
                'sub'   => array(
                    array(
                        'name'  => 'Categories',
                        'url'   => 'page_ready_forum_categories.php'
                    ),
                    array(
                        'name'  => 'Topics',
                        'url'   => 'page_ready_forum_topics.php'
                    ),
                    array(
                        'name'  => 'Conversation',
                        'url'   => 'page_ready_forum_conversation.php'
                    )
                )
            ),
            array(
    ...
    array(
        ...
        'sub'   => array(
            array(
                'name'  => 'Login with animation',
                'url'   => 'page_login.php'
            ),
            array(
                'name'  => 'Login without animation',
                'url'   => 'page_login_alt.php'
            )
        )
    ),
    array(
