    ...
    <div class="row">
        <div class="col-lg-7 col-sm-7 address">
            ...
            <div class="contact-form">
                ...
                <h4>Ingresa tus datos para iniciar en Instarespuesta!</h4>
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                     Al hacer clic en <strong>“Registrarse”</strong> indica que acepta los <?= $this->Html->link('Términos de servicio', array('controller'=>'members','action'=>'termsandconditions'),array('class'=>'linked','scape'=>false)) ?>
                </div>
