...
-- Volcando estructura de base de datos para skimia_instarespuesta
CREATE DATABASE IF NOT EXISTS `skimia_instarespuesta` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `skimia_instarespuesta`;


-- Volcando estructura para tabla skimia_instarespuesta.accounts
CREATE TABLE IF NOT EXISTS `accounts` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `type` enum('MEMBER ACCOUNT','EXPERT ACCOUNT') NOT NULL,
  `balance` decimal(20,2) DEFAULT NULL,
  `sincedate` datetime DEFAULT NULL,
  `paymentmethod` enum('AUTOMATIC','ONE TIME') DEFAULT NULL,
  `paymentkey` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

-- Volcando datos para la tabla skimia_instarespuesta.accounts: 0 rows
/*!40000 ALTER TABLE `accounts` DISABLE KEYS */;
/*!40000 ALTER TABLE `accounts` ENABLE KEYS */;


-- Volcando estructura para tabla skimia_instarespuesta.administrators
...
-- Volcando datos para la tabla skimia_instarespuesta.administrators: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `administrators` DISABLE KEYS */;
/*!40000 ALTER TABLE `administrators` ENABLE KEYS */;


-- Volcando estructura para tabla skimia_instarespuesta.bankaccounts
CREATE TABLE IF NOT EXISTS `bankaccounts` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `account_id` bigint(20) NOT NULL,
  `bank_id` int(11) NOT NULL,
  `nameonbank` varchar(45) NOT NULL,
  `bankaccounttype` enum('CHECKING ACCOUNT','SAVINGS ACCOUNT') NOT NULL,
  `bankaccountnumber` varchar(16) NOT NULL,
  `active` tinyint(4) NOT NULL DEFAULT '1',
  `registerdate` datetime NOT NULL,
  PRIMARY KEY (`id`,`account_id`,`bank_id`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

-- Volcando datos para la tabla skimia_instarespuesta.bankaccounts: 0 rows
/*!40000 ALTER TABLE `bankaccounts` DISABLE KEYS */;
/*!40000 ALTER TABLE `bankaccounts` ENABLE KEYS */;


-- Volcando estructura para tabla skimia_instarespuesta.banks
...
-- Volcando datos para la tabla skimia_instarespuesta.banks: 0 rows
/*!40000 ALTER TABLE `banks` DISABLE KEYS */;
/*!40000 ALTER TABLE `banks` ENABLE KEYS */;


-- Volcando estructura para tabla skimia_instarespuesta.categories
...
-- Volcando datos para la tabla skimia_instarespuesta.categories: 0 rows
/*!40000 ALTER TABLE `categories` DISABLE KEYS */;
/*!40000 ALTER TABLE `categories` ENABLE KEYS */;


-- Volcando estructura para tabla skimia_instarespuesta.cities
...
-- Volcando datos para la tabla skimia_instarespuesta.cities: 4.079 rows
...
-- Volcando estructura para tabla skimia_instarespuesta.companies
...
-- Volcando datos para la tabla skimia_instarespuesta.companies: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `companies` DISABLE KEYS */;
INSERT INTO `companies` (`id`, `name`, `date_create`, `user`) VALUES
	(1, 'BRAINWINNER', '2014-03-20', NULL);
/*!40000 ALTER TABLE `companies` ENABLE KEYS */;


-- Volcando estructura para tabla skimia_instarespuesta.countries
...
-- Volcando datos para la tabla skimia_instarespuesta.countries: ~239 rows (aproximadamente)
/*!40000 ALTER TABLE `countries` DISABLE KEYS */;
INSERT INTO `countries` (`id`, `name`, `continent`, `region`, `population`, `localname`, `city_id`, `code2`) VALUES
	('ABW', 'Aruba', 'North America', 'Caribbean', 103000, 'Aruba', 129, 'AW'),
	('AFG', 'Afghanistan', 'Asia', 'Southern and Central Asia', 22720000, 'Afganistan/Afqanestan', 1, 'AF'),
	('AGO', 'Angola', 'Africa', 'Central Africa', 12878000, 'Angola', 56, 'AO'),
	('AIA', 'Anguilla', 'North America', 'Caribbean', 8000, 'Anguilla', 62, 'AI'),
	('ALB', 'Albania', 'Europe', 'Southern Europe', 3401200, 'ShqipÃ«ria', 34, 'AL'),
	('AND', 'Andorra', 'Europe', 'Southern Europe', 78000, 'Andorra', 55, 'AD'),
	('ANT', 'Netherlands Antilles', 'North America', 'Caribbean', 217000, 'Nederlandse Antillen', 33, 'AN'),
	('ARE', 'United Arab Emirates', 'Asia', 'Middle East', 2441000, 'Al-Imarat al-Â´Arabiya al-Muttahida', 65, 'AE'),
	('ARG', 'Argentina', 'South America', 'South America', 37032000, 'Argentina', 69, 'AR'),
	('ARM', 'Armenia', 'Asia', 'Middle East', 3520000, 'Hajastan', 126, 'AM'),
	('ASM', 'American Samoa', 'Oceania', 'Polynesia', 68000, 'Amerika Samoa', 54, 'AS'),
	('ATA', 'Antarctica', 'Antarctica', 'Antarctica', 0, 'Â–', NULL, 'AQ'),
	('ATF', 'French Southern territories', 'Antarctica', 'Antarctica', 0, 'Terres australes franÃ§aises', NULL, 'TF'),
	('ATG', 'Antigua and Barbuda', 'North America', 'Caribbean', 68000, 'Antigua and Barbuda', 63, 'AG'),
	('AUS', 'Australia', 'Oceania', 'Australia and New Zealand', 18886000, 'Australia', 135, 'AU'),
	('AUT', 'Austria', 'Europe', 'Western Europe', 8091800, 'Ã–sterreich', 1523, 'AT'),
	('AZE', 'Azerbaijan', 'Asia', 'Middle East', 7734000, 'AzÃ¤rbaycan', 144, 'AZ'),
	('BDI', 'Burundi', 'Africa', 'Eastern Africa', 6695000, 'Burundi/Uburundi', 552, 'BI'),
	('BEL', 'Belgium', 'Europe', 'Western Europe', 10239000, 'BelgiÃ«/Belgique', 179, 'BE'),
	('BEN', 'Benin', 'Africa', 'Western Africa', 6097000, 'BÃ©nin', 187, 'BJ'),
	('BFA', 'Burkina Faso', 'Africa', 'Western Africa', 11937000, 'Burkina Faso', 549, 'BF'),
	('BGD', 'Bangladesh', 'Asia', 'Southern and Central Asia', 129155000, 'Bangladesh', 150, 'BD'),
	('BGR', 'Bulgaria', 'Europe', 'Eastern Europe', 8190900, 'Balgarija', 539, 'BG'),
	('BHR', 'Bahrain', 'Asia', 'Middle East', 617000, 'Al-Bahrayn', 149, 'BH'),
	('BHS', 'Bahamas', 'North America', 'Caribbean', 307000, 'The Bahamas', 148, 'BS'),
	('BIH', 'Bosnia and Herzegovina', 'Europe', 'Southern Europe', 3972000, 'Bosna i Hercegovina', 201, 'BA'),
	('BLR', 'Belarus', 'Europe', 'Eastern Europe', 10236000, 'Belarus', 3520, 'BY'),
	('BLZ', 'Belize', 'North America', 'Central America', 241000, 'Belize', 185, 'BZ'),
	('BMU', 'Bermuda', 'North America', 'North America', 65000, 'Bermuda', 191, 'BM'),
	('BOL', 'Bolivia', 'South America', 'South America', 8329000, 'Bolivia', 194, 'BO'),
	('BRA', 'Brazil', 'South America', 'South America', 170115000, 'Brasil', 211, 'BR'),
	('BRB', 'Barbados', 'North America', 'Caribbean', 270000, 'Barbados', 174, 'BB'),
	('BRN', 'Brunei', 'Asia', 'Southeast Asia', 328000, 'Brunei Darussalam', 538, 'BN'),
	('BTN', 'Bhutan', 'Asia', 'Southern and Central Asia', 2124000, 'Druk-Yul', 192, 'BT'),
	('BVT', 'Bouvet Island', 'Antarctica', 'Antarctica', 0, 'BouvetÃ¸ya', NULL, 'BV'),
	('BWA', 'Botswana', 'Africa', 'Southern Africa', 1622000, 'Botswana', 204, 'BW'),
	('CAF', 'Central African Republic', 'Africa', 'Central Africa', 3615000, 'Centrafrique/BÃª-AfrÃ®ka', 1889, 'CF'),
	('CAN', 'Canada', 'North America', 'North America', 31147000, 'Canada', 1822, 'CA'),
	('CCK', 'Cocos (Keeling) Islands', 'Oceania', 'Australia and New Zealand', 600, 'Cocos (Keeling) Islands', 2317, 'CC'),
	('CHE', 'Switzerland', 'Europe', 'Western Europe', 7160400, 'Schweiz/Suisse/Svizzera/Svizra', 3248, 'CH'),
	('CHL', 'Chile', 'South America', 'South America', 15211000, 'Chile', 554, 'CL'),
	('CHN', 'China', 'Asia', 'Eastern Asia', 1277558000, 'Zhongquo', 1891, 'CN'),
	('CIV', 'CÃ´te dÂ’Ivoire', 'Africa', 'Western Africa', 14786000, 'CÃ´te dÂ’Ivoire', 2814, 'CI'),
	('CMR', 'Cameroon', 'Africa', 'Central Africa', 15085000, 'Cameroun/Cameroon', 1804, 'CM'),
	('COD', 'Congo, The Democratic Republic of the', 'Africa', 'Central Africa', 51654000, 'RÃ©publique DÃ©mocratique du Congo', 2298, 'CD'),
	('COG', 'Congo', 'Africa', 'Central Africa', 2943000, 'Congo', 2296, 'CG'),
	('COK', 'Cook Islands', 'Oceania', 'Polynesia', 20000, 'The Cook Islands', 583, 'CK'),
	('COL', 'Colombia', 'South America', 'South America', 42321000, 'Colombia', 2257, 'CO'),
	('COM', 'Comoros', 'Africa', 'Eastern Africa', 578000, 'Komori/Comores', 2295, 'KM'),
	('CPV', 'Cape Verde', 'Africa', 'Western Africa', 428000, 'Cabo Verde', 1859, 'CV'),
	('CRI', 'Costa Rica', 'North America', 'Central America', 4023000, 'Costa Rica', 584, 'CR'),
	('CUB', 'Cuba', 'North America', 'Caribbean', 11201000, 'Cuba', 2413, 'CU'),
	('CXR', 'Christmas Island', 'Oceania', 'Australia and New Zealand', 2500, 'Christmas Island', 1791, 'CX'),
	('CYM', 'Cayman Islands', 'North America', 'Caribbean', 38000, 'Cayman Islands', 553, 'KY'),
	('CYP', 'Cyprus', 'Asia', 'Middle East', 754700, 'KÃ½pros/Kibris', 2430, 'CY'),
	('CZE', 'Czech Republic', 'Europe', 'Eastern Europe', 10278100, 'Â¸esko', 3339, 'CZ'),
	('DEU', 'Germany', 'Europe', 'Western Europe', 82164700, 'Deutschland', 3068, 'DE'),
	('DJI', 'Djibouti', 'Africa', 'Eastern Africa', 638000, 'Djibouti/Jibuti', 585, 'DJ'),
	('DMA', 'Dominica', 'North America', 'Caribbean', 71000, 'Dominica', 586, 'DM'),
	('DNK', 'Denmark', 'Europe', 'Nordic Countries', 5330000, 'Danmark', 3315, 'DK'),
	('DOM', 'Dominican Republic', 'North America', 'Caribbean', 8495000, 'RepÃºblica Dominicana', 587, 'DO'),
	('DZA', 'Algeria', 'Africa', 'Northern Africa', 31471000, 'Al-JazaÂ’ir/AlgÃ©rie', 35, 'DZ'),
	('ECU', 'Ecuador', 'South America', 'South America', 12646000, 'Ecuador', 594, 'EC'),
	('EGY', 'Egypt', 'Africa', 'Northern Africa', 68470000, 'Misr', 608, 'EG'),
	('ERI', 'Eritrea', 'Africa', 'Eastern Africa', 3850000, 'Ertra', 652, 'ER'),
	('ESH', 'Western Sahara', 'Africa', 'Northern Africa', 293000, 'As-Sahrawiya', 2453, 'EH'),
	('ESP', 'Spain', 'Europe', 'Southern Europe', 39441700, 'EspaÃ±a', 653, 'ES'),
	('EST', 'Estonia', 'Europe', 'Baltic Countries', 1439200, 'Eesti', 3791, 'EE'),
	('ETH', 'Ethiopia', 'Africa', 'Eastern Africa', 62565000, 'YeItyopÂ´iya', 756, 'ET'),
	('FIN', 'Finland', 'Europe', 'Nordic Countries', 5171300, 'Suomi', 3236, 'FI'),
	('FJI', 'Fiji Islands', 'Oceania', 'Melanesia', 817000, 'Fiji Islands', 764, 'FJ'),
	('FLK', 'Falkland Islands', 'South America', 'South America', 2000, 'Falkland Islands', 763, 'FK'),
	('FRA', 'France', 'Europe', 'Western Europe', 59225700, 'France', 2974, 'FR'),
	('FRO', 'Faroe Islands', 'Europe', 'Nordic Countries', 43000, 'FÃ¸royar', 901, 'FO'),
	('FSM', 'Micronesia, Federated States of', 'Oceania', 'Micronesia', 119000, 'Micronesia', 2689, 'FM'),
	('GAB', 'Gabon', 'Africa', 'Central Africa', 1226000, 'Le Gabon', 902, 'GA'),
	('GBR', 'United Kingdom', 'Europe', 'British Islands', 59623400, 'United Kingdom', 456, 'GB'),
	('GEO', 'Georgia', 'Asia', 'Middle East', 4968000, 'Sakartvelo', 905, 'GE'),
	('GHA', 'Ghana', 'Africa', 'Western Africa', 20212000, 'Ghana', 910, 'GH'),
	('GIB', 'Gibraltar', 'Europe', 'Southern Europe', 25000, 'Gibraltar', 915, 'GI'),
	('GIN', 'Guinea', 'Africa', 'Western Africa', 7430000, 'GuinÃ©e', 926, 'GN'),
	('GLP', 'Guadeloupe', 'North America', 'Caribbean', 456000, 'Guadeloupe', 919, 'GP'),
	('GMB', 'Gambia', 'Africa', 'Western Africa', 1305000, 'The Gambia', 904, 'GM'),
	('GNB', 'Guinea-Bissau', 'Africa', 'Western Africa', 1213000, 'GuinÃ©-Bissau', 927, 'GW'),
	('GNQ', 'Equatorial Guinea', 'Africa', 'Central Africa', 453000, 'Guinea Ecuatorial', 2972, 'GQ'),
	('GRC', 'Greece', 'Europe', 'Southern Europe', 10545700, 'EllÃ¡da', 2401, 'GR'),
	('GRD', 'Grenada', 'North America', 'Caribbean', 94000, 'Grenada', 916, 'GD'),
	('GRL', 'Greenland', 'North America', 'North America', 56000, 'Kalaallit Nunaat/GrÃ¸nland', 917, 'GL'),
	('GTM', 'Guatemala', 'North America', 'Central America', 11385000, 'Guatemala', 922, 'GT'),
	('GUF', 'French Guiana', 'South America', 'South America', 181000, 'Guyane franÃ§aise', 3014, 'GF'),
	('GUM', 'Guam', 'Oceania', 'Micronesia', 168000, 'Guam', 921, 'GU'),
	('GUY', 'Guyana', 'South America', 'South America', 861000, 'Guyana', 928, 'GY'),
	('HKG', 'Hong Kong', 'Asia', 'Eastern Asia', 6782000, 'Xianggang/Hong Kong', 937, 'HK'),
	('HMD', 'Heard Island and McDonald Islands', 'Antarctica', 'Antarctica', 0, 'Heard and McDonald Islands', NULL, 'HM'),
	('HND', 'Honduras', 'North America', 'Central America', 6485000, 'Honduras', 933, 'HN'),
	('HRV', 'Croatia', 'Europe', 'Southern Europe', 4473000, 'Hrvatska', 2409, 'HR'),
	('HTI', 'Haiti', 'North America', 'Caribbean', 8222000, 'HaÃ¯ti/Dayti', 929, 'HT'),
	('HUN', 'Hungary', 'Europe', 'Eastern Europe', 10043200, 'MagyarorszÃ¡g', 3483, 'HU'),
	('IDN', 'Indonesia', 'Asia', 'Southeast Asia', 212107000, 'Indonesia', 939, 'ID'),
	('IND', 'India', 'Asia', 'Southern and Central Asia', 1013662000, 'Bharat/India', 1109, 'IN'),
	('IOT', 'British Indian Ocean Territory', 'Africa', 'Eastern Africa', 0, 'British Indian Ocean Territory', NULL, 'IO'),
	('IRL', 'Ireland', 'Europe', 'British Islands', 3775100, 'Ireland/Ã‰ire', 1447, 'IE'),
	('IRN', 'Iran', 'Asia', 'Southern and Central Asia', 67702000, 'Iran', 1380, 'IR'),
	('IRQ', 'Iraq', 'Asia', 'Middle East', 23115000, 'Al-Â´Iraq', 1365, 'IQ'),
	('ISL', 'Iceland', 'Europe', 'Nordic Countries', 279000, 'Ãsland', 1449, 'IS'),
	('ISR', 'Israel', 'Asia', 'Middle East', 6217000, 'YisraÂ’el/IsraÂ’il', 1450, 'IL'),
	('ITA', 'Italy', 'Europe', 'Southern Europe', 57680000, 'Italia', 1464, 'IT'),
	('JAM', 'Jamaica', 'North America', 'Caribbean', 2583000, 'Jamaica', 1530, 'JM'),
	('JOR', 'Jordan', 'Asia', 'Middle East', 5083000, 'Al-Urdunn', 1786, 'JO'),
	('JPN', 'Japan', 'Asia', 'Eastern Asia', 126714000, 'Nihon/Nippon', 1532, 'JP'),
	('KAZ', 'Kazakstan', 'Asia', 'Southern and Central Asia', 16223000, 'Qazaqstan', 1864, 'KZ'),
	('KEN', 'Kenya', 'Africa', 'Eastern Africa', 30080000, 'Kenya', 1881, 'KE'),
	('KGZ', 'Kyrgyzstan', 'Asia', 'Southern and Central Asia', 4699000, 'Kyrgyzstan', 2253, 'KG'),
	('KHM', 'Cambodia', 'Asia', 'Southeast Asia', 11168000, 'KÃ¢mpuchÃ©a', 1800, 'KH'),
	('KIR', 'Kiribati', 'Oceania', 'Micronesia', 83000, 'Kiribati', 2256, 'KI'),
	('KNA', 'Saint Kitts and Nevis', 'North America', 'Caribbean', 38000, 'Saint Kitts and Nevis', 3064, 'KN'),
	('KOR', 'South Korea', 'Asia', 'Eastern Asia', 46844000, 'Taehan MinÂ’guk (Namhan)', 2331, 'KR'),
	('KWT', 'Kuwait', 'Asia', 'Middle East', 1972000, 'Al-Kuwayt', 2429, 'KW'),
	('LAO', 'Laos', 'Asia', 'Southeast Asia', 5433000, 'Lao', 2432, 'LA'),
	('LBN', 'Lebanon', 'Asia', 'Middle East', 3282000, 'Lubnan', 2438, 'LB'),
	('LBR', 'Liberia', 'Africa', 'Western Africa', 3154000, 'Liberia', 2440, 'LR'),
	('LBY', 'Libyan Arab Jamahiriya', 'Africa', 'Northern Africa', 5605000, 'Libiya', 2441, 'LY'),
	('LCA', 'Saint Lucia', 'North America', 'Caribbean', 154000, 'Saint Lucia', 3065, 'LC'),
	('LIE', 'Liechtenstein', 'Europe', 'Western Europe', 32300, 'Liechtenstein', 2446, 'LI'),
	('LKA', 'Sri Lanka', 'Asia', 'Southern and Central Asia', 18827000, 'Sri Lanka/Ilankai', 3217, 'LK'),
	('LSO', 'Lesotho', 'Africa', 'Southern Africa', 2153000, 'Lesotho', 2437, 'LS'),
	('LTU', 'Lithuania', 'Europe', 'Baltic Countries', 3698500, 'Lietuva', 2447, 'LT'),
	('LUX', 'Luxembourg', 'Europe', 'Western Europe', 435700, 'Luxembourg/LÃ«tzebuerg', 2452, 'LU'),
	('LVA', 'Latvia', 'Europe', 'Baltic Countries', 2424200, 'Latvija', 2434, 'LV'),
	('MAC', 'Macao', 'Asia', 'Eastern Asia', 473000, 'Macau/Aomen', 2454, 'MO'),
	('MAR', 'Morocco', 'Africa', 'Northern Africa', 28351000, 'Al-Maghrib', 2486, 'MA'),
	('MCO', 'Monaco', 'Europe', 'Western Europe', 34000, 'Monaco', 2695, 'MC'),
	('MDA', 'Moldova', 'Europe', 'Eastern Europe', 4380000, 'Moldova', 2690, 'MD'),
	('MDG', 'Madagascar', 'Africa', 'Eastern Africa', 15942000, 'Madagasikara/Madagascar', 2455, 'MG'),
	('MDV', 'Maldives', 'Asia', 'Southern and Central Asia', 286000, 'Dhivehi Raajje/Maldives', 2463, 'MV'),
	('MEX', 'Mexico', 'North America', 'Central America', 98881000, 'MÃ©xico', 2515, 'MX'),
	('MHL', 'Marshall Islands', 'Oceania', 'Micronesia', 64000, 'Marshall Islands/Majol', 2507, 'MH'),
	('MKD', 'Macedonia', 'Europe', 'Southern Europe', 2024000, 'Makedonija', 2460, 'MK'),
	('MLI', 'Mali', 'Africa', 'Western Africa', 11234000, 'Mali', 2482, 'ML'),
	('MLT', 'Malta', 'Europe', 'Southern Europe', 380200, 'Malta', 2484, 'MT'),
	('MMR', 'Myanmar', 'Asia', 'Southeast Asia', 45611000, 'Myanma Pye', 2710, 'MM'),
	('MNG', 'Mongolia', 'Asia', 'Eastern Asia', 2662000, 'Mongol Uls', 2696, 'MN'),
	('MNP', 'Northern Mariana Islands', 'Oceania', 'Micronesia', 78000, 'Northern Mariana Islands', 2913, 'MP'),
	('MOZ', 'Mozambique', 'Africa', 'Eastern Africa', 19680000, 'MoÃ§ambique', 2698, 'MZ'),
	('MRT', 'Mauritania', 'Africa', 'Western Africa', 2670000, 'Muritaniya/Mauritanie', 2509, 'MR'),
	('MSR', 'Montserrat', 'North America', 'Caribbean', 11000, 'Montserrat', 2697, 'MS'),
	('MTQ', 'Martinique', 'North America', 'Caribbean', 395000, 'Martinique', 2508, 'MQ'),
	('MUS', 'Mauritius', 'Africa', 'Eastern Africa', 1158000, 'Mauritius', 2511, 'MU'),
	('MWI', 'Malawi', 'Africa', 'Eastern Africa', 10925000, 'Malawi', 2462, 'MW'),
	('MYS', 'Malaysia', 'Asia', 'Southeast Asia', 22244000, 'Malaysia', 2464, 'MY'),
	('MYT', 'Mayotte', 'Africa', 'Eastern Africa', 149000, 'Mayotte', 2514, 'YT'),
	('NAM', 'Namibia', 'Africa', 'Southern Africa', 1726000, 'Namibia', 2726, 'NA'),
	('NCL', 'New Caledonia', 'Oceania', 'Melanesia', 214000, 'Nouvelle-CalÃ©donie', 3493, 'NC'),
	('NER', 'Niger', 'Africa', 'Western Africa', 10730000, 'Niger', 2738, 'NE'),
	('NFK', 'Norfolk Island', 'Oceania', 'Australia and New Zealand', 2000, 'Norfolk Island', 2806, 'NF'),
	('NGA', 'Nigeria', 'Africa', 'Western Africa', 111506000, 'Nigeria', 2754, 'NG'),
	('NIC', 'Nicaragua', 'North America', 'Central America', 5074000, 'Nicaragua', 2734, 'NI'),
	('NIU', 'Niue', 'Oceania', 'Polynesia', 2000, 'Niue', 2805, 'NU'),
	('NLD', 'Netherlands', 'Europe', 'Western Europe', 15864000, 'Nederland', 5, 'NL'),
	('NOR', 'Norway', 'Europe', 'Nordic Countries', 4478500, 'Norge', 2807, 'NO'),
	('NPL', 'Nepal', 'Asia', 'Southern and Central Asia', 23930000, 'Nepal', 2729, 'NP'),
	('NRU', 'Nauru', 'Oceania', 'Micronesia', 12000, 'Naoero/Nauru', 2728, 'NR'),
	('NZL', 'New Zealand', 'Oceania', 'Australia and New Zealand', 3862000, 'New Zealand/Aotearoa', 3499, 'NZ'),
	('OMN', 'Oman', 'Asia', 'Middle East', 2542000, 'Â´Uman', 2821, 'OM'),
	('PAK', 'Pakistan', 'Asia', 'Southern and Central Asia', 156483000, 'Pakistan', 2831, 'PK'),
	('PAN', 'Panama', 'North America', 'Central America', 2856000, 'PanamÃ¡', 2882, 'PA'),
	('PCN', 'Pitcairn', 'Oceania', 'Polynesia', 50, 'Pitcairn', 2912, 'PN'),
	('PER', 'Peru', 'South America', 'South America', 25662000, 'PerÃº/Piruw', 2890, 'PE'),
	('PHL', 'Philippines', 'Asia', 'Southeast Asia', 75967000, 'Pilipinas', 766, 'PH'),
	('PLW', 'Palau', 'Oceania', 'Micronesia', 19000, 'Belau/Palau', 2881, 'PW'),
	('PNG', 'Papua New Guinea', 'Oceania', 'Melanesia', 4807000, 'Papua New Guinea/Papua Niugini', 2884, 'PG'),
	('POL', 'Poland', 'Europe', 'Eastern Europe', 38653600, 'Polska', 2928, 'PL'),
	('PRI', 'Puerto Rico', 'North America', 'Caribbean', 3869000, 'Puerto Rico', 2919, 'PR'),
	('PRK', 'North Korea', 'Asia', 'Eastern Asia', 24039000, 'Choson Minjujuui InÂ´min Konghwaguk (Bukhan)', 2318, 'KP'),
	('PRT', 'Portugal', 'Europe', 'Southern Europe', 9997600, 'Portugal', 2914, 'PT'),
	('PRY', 'Paraguay', 'South America', 'South America', 5496000, 'Paraguay', 2885, 'PY'),
	('PSE', 'Palestine', 'Asia', 'Middle East', 3101000, 'Filastin', 4074, 'PS'),
	('PYF', 'French Polynesia', 'Oceania', 'Polynesia', 235000, 'PolynÃ©sie franÃ§aise', 3016, 'PF'),
	('QAT', 'Qatar', 'Asia', 'Middle East', 599000, 'Qatar', 2973, 'QA'),
	('REU', 'RÃ©union', 'Africa', 'Eastern Africa', 699000, 'RÃ©union', 3017, 'RE'),
	('ROM', 'Romania', 'Europe', 'Eastern Europe', 22455500, 'RomÃ¢nia', 3018, 'RO'),
	('RUS', 'Russian Federation', 'Europe', 'Eastern Europe', 146934000, 'Rossija', 3580, 'RU'),
	('RWA', 'Rwanda', 'Africa', 'Eastern Africa', 7733000, 'Rwanda/Urwanda', 3047, 'RW'),
	('SAU', 'Saudi Arabia', 'Asia', 'Middle East', 21607000, 'Al-Â´Arabiya as-SaÂ´udiya', 3173, 'SA'),
	('SDN', 'Sudan', 'Africa', 'Northern Africa', 29490000, 'As-Sudan', 3225, 'SD'),
	('SEN', 'Senegal', 'Africa', 'Western Africa', 9481000, 'SÃ©nÃ©gal/Sounougal', 3198, 'SN'),
	('SGP', 'Singapore', 'Asia', 'Southeast Asia', 3567000, 'Singapore/Singapura/Xinjiapo/Singapur', 3208, 'SG'),
	('SGS', 'South Georgia and the South Sandwich Islands', 'Antarctica', 'Antarctica', 0, 'South Georgia and the South Sandwich Islands', NULL, 'GS'),
	('SHN', 'Saint Helena', 'Africa', 'Western Africa', 6000, 'Saint Helena', 3063, 'SH'),
	('SJM', 'Svalbard and Jan Mayen', 'Europe', 'Nordic Countries', 3200, 'Svalbard og Jan Mayen', 938, 'SJ'),
	('SLB', 'Solomon Islands', 'Oceania', 'Melanesia', 444000, 'Solomon Islands', 3161, 'SB'),
	('SLE', 'Sierra Leone', 'Africa', 'Western Africa', 4854000, 'Sierra Leone', 3207, 'SL'),
	('SLV', 'El Salvador', 'North America', 'Central America', 6276000, 'El Salvador', 645, 'SV'),
	('SMR', 'San Marino', 'Europe', 'Southern Europe', 27000, 'San Marino', 3171, 'SM'),
	('SOM', 'Somalia', 'Africa', 'Eastern Africa', 10097000, 'Soomaaliya', 3214, 'SO'),
	('SPM', 'Saint Pierre and Miquelon', 'North America', 'North America', 7000, 'Saint-Pierre-et-Miquelon', 3067, 'PM'),
	('STP', 'Sao Tome and Principe', 'Africa', 'Central Africa', 147000, 'SÃ£o TomÃ© e PrÃ­ncipe', 3172, 'ST'),
	('SUR', 'Suriname', 'South America', 'South America', 417000, 'Suriname', 3243, 'SR'),
	('SVK', 'Slovakia', 'Europe', 'Eastern Europe', 5398700, 'Slovensko', 3209, 'SK'),
	('SVN', 'Slovenia', 'Europe', 'Southern Europe', 1987800, 'Slovenija', 3212, 'SI'),
	('SWE', 'Sweden', 'Europe', 'Nordic Countries', 8861400, 'Sverige', 3048, 'SE'),
	('SWZ', 'Swaziland', 'Africa', 'Southern Africa', 1008000, 'kaNgwane', 3244, 'SZ'),
	('SYC', 'Seychelles', 'Africa', 'Eastern Africa', 77000, 'Sesel/Seychelles', 3206, 'SC'),
	('SYR', 'Syria', 'Asia', 'Middle East', 16125000, 'Suriya', 3250, 'SY'),
	('TCA', 'Turks and Caicos Islands', 'North America', 'Caribbean', 17000, 'The Turks and Caicos Islands', 3423, 'TC'),
	('TCD', 'Chad', 'Africa', 'Central Africa', 7651000, 'Tchad/Tshad', 3337, 'TD'),
	('TGO', 'Togo', 'Africa', 'Western Africa', 4629000, 'Togo', 3332, 'TG'),
	('THA', 'Thailand', 'Asia', 'Southeast Asia', 61399000, 'Prathet Thai', 3320, 'TH'),
	('TJK', 'Tajikistan', 'Asia', 'Southern and Central Asia', 6188000, 'ToÃ§ikiston', 3261, 'TJ'),
	('TKL', 'Tokelau', 'Oceania', 'Polynesia', 2000, 'Tokelau', 3333, 'TK'),
	('TKM', 'Turkmenistan', 'Asia', 'Southern and Central Asia', 4459000, 'TÃ¼rkmenostan', 3419, 'TM'),
	('TMP', 'East Timor', 'Asia', 'Southeast Asia', 885000, 'Timor Timur', 1522, 'TP'),
	('TON', 'Tonga', 'Oceania', 'Polynesia', 99000, 'Tonga', 3334, 'TO'),
	('TTO', 'Trinidad and Tobago', 'North America', 'Caribbean', 1295000, 'Trinidad and Tobago', 3336, 'TT'),
	('TUN', 'Tunisia', 'Africa', 'Northern Africa', 9586000, 'Tunis/Tunisie', 3349, 'TN'),
	('TUR', 'Turkey', 'Asia', 'Middle East', 66591000, 'TÃ¼rkiye', 3358, 'TR'),
	('TUV', 'Tuvalu', 'Oceania', 'Polynesia', 12000, 'Tuvalu', 3424, 'TV'),
	('TWN', 'Taiwan', 'Asia', 'Eastern Asia', 22256000, 'TÂ’ai-wan', 3263, 'TW'),
	('TZA', 'Tanzania', 'Africa', 'Eastern Africa', 33517000, 'Tanzania', 3306, 'TZ'),
	('UGA', 'Uganda', 'Africa', 'Eastern Africa', 21778000, 'Uganda', 3425, 'UG'),
	('UKR', 'Ukraine', 'Europe', 'Eastern Europe', 50456000, 'Ukrajina', 3426, 'UA'),
	('UMI', 'United States Minor Outlying Islands', 'Oceania', 'Micronesia/Caribbean', 0, 'United States Minor Outlying Islands', NULL, 'UM'),
	('URY', 'Uruguay', 'South America', 'South America', 3337000, 'Uruguay', 3492, 'UY'),
	('USA', 'United States', 'North America', 'North America', 278357000, 'United States', 3813, 'US'),
	('UZB', 'Uzbekistan', 'Asia', 'Southern and Central Asia', 24318000, 'Uzbekiston', 3503, 'UZ'),
	('VAT', 'Holy See (Vatican City State)', 'Europe', 'Southern Europe', 1000, 'Santa Sede/CittÃ  del Vaticano', 3538, 'VA'),
	('VCT', 'Saint Vincent and the Grenadines', 'North America', 'Caribbean', 114000, 'Saint Vincent and the Grenadines', 3066, 'VC'),
	('VEN', 'Venezuela', 'South America', 'South America', 24170000, 'Venezuela', 3539, 'VE'),
	('VGB', 'Virgin Islands, British', 'North America', 'Caribbean', 21000, 'British Virgin Islands', 537, 'VG'),
	('VIR', 'Virgin Islands, U.S.', 'North America', 'Caribbean', 93000, 'Virgin Islands of the United States', 4067, 'VI'),
	('VNM', 'Vietnam', 'Asia', 'Southeast Asia', 79832000, 'ViÃªt Nam', 3770, 'VN'),
	('VUT', 'Vanuatu', 'Oceania', 'Melanesia', 190000, 'Vanuatu', 3537, 'VU'),
	('WLF', 'Wallis and Futuna', 'Oceania', 'Polynesia', 15000, 'Wallis-et-Futuna', 3536, 'WF'),
	('WSM', 'Samoa', 'Oceania', 'Polynesia', 180000, 'Samoa', 3169, 'WS'),
	('YEM', 'Yemen', 'Asia', 'Middle East', 18112000, 'Al-Yaman', 1780, 'YE'),
	('YUG', 'Yugoslavia', 'Europe', 'Southern Europe', 10640000, 'Jugoslavija', 1792, 'YU'),
	('ZAF', 'South Africa', 'Africa', 'Southern Africa', 40377000, 'South Africa', 716, 'ZA'),
	('ZMB', 'Zambia', 'Africa', 'Eastern Africa', 9169000, 'Zambia', 3162, 'ZM'),
	('ZWE', 'Zimbabwe', 'Africa', 'Eastern Africa', 11669000, 'Zimbabwe', 4068, 'ZW');
/*!40000 ALTER TABLE `countries` ENABLE KEYS */;


-- Volcando estructura para tabla skimia_instarespuesta.expert_ratings
...
-- Volcando datos para la tabla skimia_instarespuesta.expert_ratings: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `expert_ratings` DISABLE KEYS */;
INSERT INTO `expert_ratings` (`id`, `name`, `date_create`, `user`) VALUES
	(1, 'LEADER', '2014-03-20', NULL);
/*!40000 ALTER TABLE `expert_ratings` ENABLE KEYS */;


-- Volcando estructura para tabla skimia_instarespuesta.images
...
-- Volcando datos para la tabla skimia_instarespuesta.images: ~2 rows (aproximadamente)
/*!40000 ALTER TABLE `images` DISABLE KEYS */;
INSERT INTO `images` (`id`, `filename`, `dir`) VALUES
	(1, 'Koala.jpg', 'uploads\\image\\filename'),
	(2, 'Penguins.jpg', 'uploads\\image\\filename');
/*!40000 ALTER TABLE `images` ENABLE KEYS */;


-- Volcando estructura para tabla skimia_instarespuesta.languages
...
-- Volcando datos para la tabla skimia_instarespuesta.languages: 107 rows
/*!40000 ALTER TABLE `languages` DISABLE KEYS */;
INSERT INTO `languages` (`id`, `description`, `code`) VALUES
	(1, 'English', 'en'),
	(2, 'German', 'de'),
	(3, 'French', 'fr'),
	(4, 'Dutch', 'nl'),
	...
	(59, 'Cebuano', 'ceb'),
	(60, 'Tamil', 'ta'),
	(61, 'Belarusian (Taraskievica)', 'be-x'),
	(62, 'Breton', 'br'),
	(63, 'Latvian', 'lv'),
	(64, 'Javanese', 'jv'),
	(65, 'Albanian', 'sq'),
...
-- Volcando estructura para tabla skimia_instarespuesta.meetings
CREATE TABLE IF NOT EXISTS `meetings` (
  ...
  `datecallcomplete` datetime DEFAULT NULL,
  `pathtoconversation` varchar(500) DEFAULT NULL,
  `type` enum('CALL','PRESENCIAL') DEFAULT NULL,
  `timemeeting` time DEFAULT NULL,
  `starttime` time DEFAULT NULL,
  `endtime` time DEFAULT NULL,
  `conferencecallpin` varchar(20) DEFAULT NULL,
  `numberofparties` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`),
  KEY `fk_expert_id_call_idx` (`expert_id`),
  KEY `fk_member_id_call_idx` (`member_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Volcando datos para la tabla skimia_instarespuesta.meetings: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `meetings` DISABLE KEYS */;
/*!40000 ALTER TABLE `meetings` ENABLE KEYS */;


-- Volcando estructura para tabla skimia_instarespuesta.members
CREATE TABLE IF NOT EXISTS `members` (
  ...
  `linkedinid` varchar(20) DEFAULT NULL,
  `countvotes` int(11) DEFAULT '0',
  `sumvotes` int(11) DEFAULT '0',
  `expert` tinyint(4) DEFAULT '0',
  `administrator_id` int(11) DEFAULT NULL,
  `registerdate` datetime DEFAULT NULL,
  `lastdate` datetime DEFAULT NULL,
  `expertdate` datetime DEFAULT NULL,
  `mobilephone` varchar(19) DEFAULT NULL,
  `homephone` varchar(19) DEFAULT NULL,
  `officephone` varchar(45) DEFAULT NULL,
  `dni` varchar(20) DEFAULT NULL,
  `commercialdni` varchar(20) DEFAULT NULL,
  `company_id` int(11) DEFAULT NULL,
  `title_id` int(11) DEFAULT NULL,
  `termsandconditions` tinyint(4) DEFAULT NULL,
  `datetermsandconditions` int(11) DEFAULT NULL,
  `category_id` int(11) DEFAULT NULL,
  `city_id` int(11) DEFAULT NULL,
  `verificationstatus` smallint(6) DEFAULT '0',
  `expertstatus` enum('EARLY PROSPECT','APPLICANT','APPROVED APPLICANT','QUALIFIED EXPERT','APPROVED EXPERT','EXPERT READY') DEFAULT NULL,
  `expertrating_id` enum('LEADER','TOP QUARTILE','STANDARD') DEFAULT NULL,
  `expertrate` decimal(2,2) DEFAULT NULL,
  ...
  KEY `fk_city_id_idx` (`city_id`),
  CONSTRAINT `fk_administrator_id` FOREIGN KEY (`administrator_id`) REFERENCES `administrators` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=latin1;

-- Volcando datos para la tabla skimia_instarespuesta.members: ~15 rows (aproximadamente)
/*!40000 ALTER TABLE `members` DISABLE KEYS */;
INSERT INTO `members` (`id`, `names`, `lastnames`, `email`, `password`, `headline`, `image`, `bio`, `facebookid`, `twitterid`, `linkedinid`, `countvotes`, `sumvotes`, `expert`, `administrator_id`, `registerdate`, `lastdate`, `expertdate`, `mobilephone`, `homephone`, `officephone`, `dni`, `commercialdni`, `company_id`, `title_id`, `termsandconditions`, `datetermsandconditions`, `category_id`, `city_id`, `verificationstatus`, `expertstatus`, `expertrating_id`, `expertrate`, `public`, `gain`) VALUES
	(6, 'Fabio ', 'Arias Vera', 'fharias@gmail.com', 'a32eb4932fd0997a31938c24d6bc69b4d2721a18', '', NULL, '', NULL, NULL, NULL, 0, 0, 1, NULL, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, '(+56)(2)(1234-5678)', '', '', '8.899.888-8', '88249423-3', NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL, 1, NULL),
	(7, 'Frederick', 'Sweeting', 'fritsorama@gmail.com', '3e8e4269d82bf740cb408619378dbe2a6d517ee4', '', NULL, NULL, NULL, NULL, NULL, 0, 0, 0, NULL, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 1, NULL),
	(8, 'Javier', 'Ayelli', 'Javier.ayelli@gmail.com', '22da863d2fc6dc6c78c2d8525cec4efe647b8bcd', 'Empresario', NULL, 'BIO', NULL, NULL, NULL, 0, 0, 0, NULL, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, '569 8689 0', '', '', '14752113-8', '76314550-6', NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 1, NULL),
	(9, 'Greg', 'Tully', 'greg.tully@gmail.com', '9b75a66d9b3660be35091430a2927d89e38392cd', '', NULL, NULL, NULL, NULL, NULL, 0, 0, 0, NULL, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 1, NULL),
	(10, 'Pablo', 'Unda', 'pablo.unda@p3c.cl', '5f872a35f15fc8f268607dbab6dabeb4edc4c394', '', NULL, NULL, NULL, NULL, NULL, 0, 0, 0, NULL, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 1, NULL),
	(11, 'Guido', 'Ayala', 'guidoayala@hotmail.com', '4d3bcd71a796c7273a0da8863fd16edbbcabe7bf', 'ok', NULL, '', NULL, NULL, NULL, 0, 0, 0, NULL, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, '3003731925', '3003731925', '3003731925', '00001111', '11110000', NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 1, NULL),
	(12, '', '', '', '13714ebf6ee7bc019a9de4e0c28d20a9feaafe4b', '', NULL, NULL, NULL, NULL, NULL, 0, 0, 0, NULL, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 1, NULL),
	(13, 'jose', 'sarta', 'josarta@misena. edu. co', 'ccb5ceee2ab923fe133f30c067159163f398833d', '', NULL, NULL, NULL, NULL, NULL, 0, 0, 0, NULL, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 1, NULL),
	(14, 'jose', 'sarta', 'josarta@misena.edu.co', '1c2499e22697f7881068ab6356d427b73f475dfa', '', NULL, NULL, NULL, NULL, NULL, 0, 0, 0, NULL, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 1, NULL),
	(15, 'Pablo', 'Unda', 'undapablo@yahoo.com', '64e3009d593f34a00633ef691aa098de684d10ff', '', NULL, NULL, NULL, NULL, NULL, 0, 0, 0, NULL, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 1, NULL),
	(16, 'Greg', 'Tully', 'greg.tully@p3c.cl', '486dfc264ee448f34f97f3fd3585b67a00ce2685', '', NULL, NULL, NULL, NULL, NULL, 0, 0, 0, NULL, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 1, NULL),
	(17, 'farith', 'jhaklasdjklasd', 'fesanmiguel@misena.edu.co', '37189b7c20efc4cbf2b931e12eed2623cc759c40', '', NULL, NULL, NULL, NULL, NULL, 0, 0, 0, NULL, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 1, NULL),
	(18, 'Wilmer', 'Alzate', 'wilmeralzateroman@gmail.com', 'c256ea1166942630c5eca51659f3344abce03580', '', 'Koala.jpg', NULL, NULL, NULL, NULL, 0, 0, 0, NULL, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 1, NULL),
	(19, 'Ricardo', 'Bustos', 'bustos.ricardo@gmail.com', 'fba07cd22ce78bf7865fb30dc997be64eb1579ed', '', NULL, NULL, NULL, NULL, NULL, 0, 0, 0, NULL, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 1, NULL),
	(20, 'Ricardo', 'Bustos', 'el_duro_r6@hotmail.com', '81ae55c2d0c4714d502c0d8313c7ef610cbd1b75', '', NULL, NULL, NULL, NULL, NULL, 0, 0, 0, NULL, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, 1, NULL);
/*!40000 ALTER TABLE `members` ENABLE KEYS */;


-- Volcando estructura para tabla skimia_instarespuesta.members_languages
CREATE TABLE IF NOT EXISTS `members_languages` (
...
-- Volcando datos para la tabla skimia_instarespuesta.members_languages: 10 rows
/*!40000 ALTER TABLE `members_languages` DISABLE KEYS */;
INSERT INTO `members_languages` (`language_id`, `member_id`, `sincedate`) VALUES
	(48, 6, '2014-03-10 22:22:22'),
	(9, 6, '2014-03-10 22:22:22'),
	(6, 6, '2014-03-10 22:22:22'),
	(5, 6, '2014-03-10 22:22:22'),
	(3, 6, '2014-03-10 22:22:21'),
	(1, 6, '2014-03-10 22:22:21'),
	(1, 15, '2014-02-06 19:56:33'),
	(22, 15, '2014-02-06 19:56:33'),
	(6, 18, '2014-03-12 03:27:21'),
	(1, 18, '2014-03-12 03:27:21');
/*!40000 ALTER TABLE `members_languages` ENABLE KEYS */;


-- Volcando estructura para tabla skimia_instarespuesta.members_skills
CREATE TABLE IF NOT EXISTS `members_skills` (
  ...
  CONSTRAINT `fk_member_id_skill` FOREIGN KEY (`member_id`) REFERENCES `members` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_skill_id_skill` FOREIGN KEY (`skill_id`) REFERENCES `skills` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Volcando datos para la tabla skimia_instarespuesta.members_skills: ~5 rows (aproximadamente)
/*!40000 ALTER TABLE `members_skills` DISABLE KEYS */;
INSERT INTO `members_skills` (`member_id`, `skill_id`, `validated`) VALUES
	(6, 1, 0),
	(6, 2, 0),
	(6, 3, 0),
	(18, 5, 0),
	(18, 7, 0);
/*!40000 ALTER TABLE `members_skills` ENABLE KEYS */;


-- Volcando estructura para tabla skimia_instarespuesta.skills
...
-- Volcando datos para la tabla skimia_instarespuesta.skills: ~11 rows (aproximadamente)
...
-- Volcando estructura para tabla skimia_instarespuesta.surveys
CREATE TABLE IF NOT EXISTS `surveys` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `meeting_id` int(11) NOT NULL,
  `memberrating` int(11) DEFAULT NULL,
  `expertrating` int(11) DEFAULT NULL,
  `membercomments` varchar(250) DEFAULT NULL,
  `expertcomments` varchar(250) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

-- Volcando datos para la tabla skimia_instarespuesta.surveys: 0 rows
/*!40000 ALTER TABLE `surveys` DISABLE KEYS */;
/*!40000 ALTER TABLE `surveys` ENABLE KEYS */;


-- Volcando estructura para tabla skimia_instarespuesta.titles
...
-- Volcando datos para la tabla skimia_instarespuesta.titles: ~1 rows (aproximadamente)
/*!40000 ALTER TABLE `titles` DISABLE KEYS */;
INSERT INTO `titles` (`id`, `name`, `date_create`, `user`) VALUES
	(0, 'PROGRAMMER', '2014-03-20', 6),
	(1, 'SOFTWARE ENGINNER', '2014-03-20', 18);
